...
@WebServlet(urlPatterns = {"/Application_info_addR"})
@MultipartConfig(maxFileSize=4177215)
public class Application_info_addR extends HttpServlet {
    @Override
            ...
            throws ServletException, IOException 
    {
        ...
        reg.setTo(to);
        reg.setEmail(email);
        leave_appplication_daoR rDao = new leave_appplication_daoR();
