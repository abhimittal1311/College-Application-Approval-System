...
@WebServlet(urlPatterns = {"/gp_baddi_main"})
public class gp_baddi_main extends HttpServlet {
     @Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
         ...
         try
         {
             ...
             String que="select * from gatepass_baddi where status='Pending';";
             ...
             while(resultSet.next())
             {
              ...
              request.setAttribute("TRY3", Arr);
              request.getRequestDispatcher("/baddi_gatepass_applications.jsp").include(request, response);
