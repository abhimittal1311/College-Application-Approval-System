...
@WebServlet(urlPatterns = {"/baddi_teacher_student_list"})
public class baddi_teacher_student_list extends HttpServlet {
     @Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
         ...
         try
         {
             ...
             String que="select * from baddi_signup where admission_stat='yes';";
             ...
             while(resultSet.next())
             {
              ...
              request.setAttribute("TRY1", Arr);
              request.getRequestDispatcher("/baddi_teacher_dash.jsp").include(request, response);
