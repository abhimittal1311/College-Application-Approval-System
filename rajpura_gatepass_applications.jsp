...
<% ArrayList<gp_register_bean> ar = (ArrayList<gp_register_bean>)request.getAttribute("TRY5"); %>
<html>
    <head>
...
h1,h2,li
  ...
  <li><a class="active" href="gp_rajpura_main">Gate Pass Applications</a></li>
  <li style="float:right;"><a href="rajpura_logout.jsp">Logout</a></li>
      ...
      <table width="800" align="left" class="dash" cellspacing="15">
            ...
            <tr>
            <td>
                    <form method="post" action="Gatepass_acceptR">
                ...
                <td>
                <form method="post" action="Gatepass_rejectR">
