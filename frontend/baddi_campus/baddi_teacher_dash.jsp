...
<% ArrayList<ListingBean> ar = (ArrayList<ListingBean>)request.getAttribute("TRY1"); %>
<!DOCTYPE html>
<html>
    <head>
...
h1,h2,th,li
    ...
    <center>
        ...
        <ul>
  <li><a class="active" href="baddi_teacher_student_list">List of Enrolled Students</a></li>
