...
<% ArrayList<leave_register_bean> ar = (ArrayList<leave_register_bean>)request.getAttribute("TRY2"); %>
<html>
    <head>
...
h1,h2,li
  ...
  <li><a class="active" href="leave_baddi_main">Leave Applications</a></li>
  <li><a href="gp_baddi_main">Gate Pass Applications</a></li>
  <li style="float:right;"><a href="baddi_logout.jsp">Logout</a></li>
      ...
      <table width="800" align="left" class="dash" cellspacing="15">
            ...
            <tr>
            <td>
                    <form method="post" action="Leave_accept">
                ...
                <td>
                <form method="post" action="Leave_reject">
