...
.application-form input[type="text"], .application-form textarea, .application-form select, .application-form input[type="number"], .application-form input[type="tel"], .application-form input[type="email"]{
	margin:0px 0px;
	padding:10px 10px;
	background:#fff;
	color: #333;
...
<center><a href="https://www.chitkara.edu.in/" title="Chitkara University, Punjab"><img src="ChitkaraUniversityPunjabLogo.png" height="180px" width="180px"></a>
<form name="Application" method="post" enctype="multipart/form-data" action="InfoAddR">
   <table align="center" width="600" border="0" cellspacing="0" cellpadding="0" class="application-form">
  <tr>
    <td colspan="2"><input name="fname" type="text" placeholder="First Name*" required >
    </td>
    <td rowspan="3"> <textarea style="resize:none;" name="address" cols="41" rows="6" placeholder="Address*" required></textarea></td>
  </tr>
  <tr>
    <td colspan="2"><input name="lname" type="text" placeholder="Last Name*" required></td>
  </tr>
  <tr>
    <td colspan="2"><input name="contact" type="tel" placeholder="Contact No*" maxlength="10" required></td>
  </tr>
  
  <tr>
    <td colspan="2"><input name="email" type="email" placeholder="E-mail*" required></td>
    <td width="50%"><select id="country" name="country" required>
  ...
  <tr>
    <td colspan="2"><input name="date" placeholder="Date of Birth*" class="textbox-n" type="text" onfocus="(this.type='date')"  id="date" required></td>
    <td><input name="number" type="number" placeholder="ZipCode*" required ></td>
  </tr>
  <tr>
    <td colspan="2"><input name="fathername" type="text" placeholder="Father's Name*" required >
    </td>
    <td><input name="mothername" type="text" placeholder="Mother's Name*" required ></td>
  </tr>
  <tr>
    <td colspan="2"><select id="course" name="course" required>
    <option value="">-- Select Course to Apply* --</option>
  ...
  <tr>
    <td colspan="2"><input name="Marks12" type="number" placeholder="Marks in 12th Grade*" step=".01" required></td>
    <td><input name="school" type="text" placeholder="Name of Last Institute*" required>
        </td>
</tr>
<tr>
    <td colspan="2"><input name="Marks10" type="number" placeholder="Marks in 10th Grade*" step=".01" required></td>
    <td><input name="ug_gpa" type="number" placeholder="GPA in UG Course(for PG applicants only)" step=".01">
        </td> 
  </tr>
  <tr>
  <td colspan="2"><p>Upload your photograph.</p><input name="photo" type="file" required></td>
  <tr>
    <td colspan="2">&nbsp;</td>
