...
.leave-form input[type="submit"]{
  ...
  <li><a class="active" href="gatepass_rajpura.jsp">Apply for Gate Pass</a></li>
  <li><a href="rajpura_password_change.jsp">Change Password</a></li>
  <li style="float:right;"><a href="rajpura_logout.jsp">Logout</a></li>
</ul>
        <h1>GatePass Application Form</h1>
        <form name="applicationG" method="post" action="Gatepass_info_addR">
            <table align="center" width="600" cellspacing="0" cellpadding="0" class="leave-form">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <input name="timefrom" placeholder="From*" class="textbox-n" type="text" onfocus="(this.type='time')"  id="time" required>
                    </td>
    ...
    <option value="Master of Design User Experience">Master of Design User Experience in collaboration with ImaginXP</option>
                ...
                <tr>
                    <td colspan="1">
                        <input name="timeto" placeholder="To*" class="textbox-n" type="text" onfocus="(this.type='time')"  id="time" required>
                    </td>
                </tr>
                <tr>
    <td colspan="2">&nbsp;</td>
