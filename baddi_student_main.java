...
@WebServlet(urlPatterns = {"/baddi_student_main"})
public class baddi_student_main extends HttpServlet {
     @Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
         ...
         try
         {
              ...
              String email10=(String) session.getAttribute("xyz");
             Connection conn = DBConnection.getConnection();
             String que="select * from baddi_signup where email=(?) and admission_stat='yes';";
             ...
             while(resultSet.next())
             {
              ...
              request.setAttribute("ABC", Arr);
              request.getRequestDispatcher("/baddi_student_dash.jsp").include(request, response);
