...
@WebServlet(urlPatterns = {"/Admission_accept"})
public class Admission_accept extends HttpServlet {
     @Override
            ...
            throws ServletException, IOException 
    {
        ...
        String query="update baddi_signup set admission_stat='Yes' where email=(?);";
        PreparedStatement Ps=conn.prepareStatement(query); 
         Ps.setString(1,email);
         String query2="insert into baddi_student values(?,'chitkara');";
