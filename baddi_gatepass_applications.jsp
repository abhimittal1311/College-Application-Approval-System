...
<%@page import="ProjectPackage.gp_register_bean"%>
<%@page import="java.util.ArrayList"%>
<% ArrayList<gp_register_bean> ar = (ArrayList<gp_register_bean>)request.getAttribute("TRY3"); %>
<html>
    <head>
...
h1,h2,li
    ...
    <center>
        ...
        <h1>Teacher DashBoard</h1>
         <ul>
  <li><a  href="baddi_teacher_student_list">List of Enrolled Students</a></li>
  <li><a  href="baddi_teacher_main">Admission Applications</a></li>
  <li><a  href="leave_baddi_main">Leave Applications</a></li>
  <li><a class="active" href="gp_baddi_main">Gate Pass Applications</a></li>
<li style="float:right;"><a href="baddi_logout.jsp">Logout</a></li>
         </ul>
        <h2>Gate Pass Applications</h2>
           <%  if(!ar.isEmpty()){
      ...
      <table width="800" align="left" class="dash" cellspacing="15">
            ...
            <tr>
            <td>
                    <form method="post" action="Gatepass_accept">
                ...
                <td>
                <form method="post" action="Gatepass_reject">
