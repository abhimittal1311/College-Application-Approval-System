...
@WebServlet(urlPatterns = {"/rajpura_teacher_main"})
public class rajpura_teacher_main extends HttpServlet {
     @Override
    protected void service(HttpServletRequest request, HttpServletResponse response)
         ...
         try
         {
             ...
             String que="select * from rajpura_signup where admission_stat='no';";
             ...
             while(resultSet.next())
             {
              ...
              request.setAttribute("LOL1", Arr);
              request.getRequestDispatcher("/rajpura_admission_applications.jsp").include(request, response);
