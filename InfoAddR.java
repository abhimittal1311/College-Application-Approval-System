...
@WebServlet(urlPatterns = {"/InfoAddR"})
@MultipartConfig(maxFileSize=4177215)
public class InfoAddR extends HttpServlet {
    ...
    public void service(HttpServletRequest req,HttpServletResponse res) throws IOException ,ServletException
    {
        ...
        String ugmarks = req.getParameter("ug_gpa");
        ...
        RegisterDaoR rDao = new RegisterDaoR();
        ...
        else
        {
            ...
            req.getRequestDispatcher("/application_form_rajpura.jsp").forward(req, res);
        }
    }
