...
@WebServlet(urlPatterns = {"/Gatepass_reject"})
public class Gatepass_reject extends HttpServlet {
     @Override
            ...
            throws ServletException, IOException 
    {
        ...
        String query="update gatepass_baddi set status='Rejected' where email=(?);";
